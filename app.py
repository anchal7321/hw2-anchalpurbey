...
Workflow: Takes a built-in meeting transcript and generates:
  1. A brief summary of important points to consider
  2. Actionable next steps
Usage:
  python app.py --case 1 --prompt v1
  python app.py --case 3 --prompt v2
"""
...
Respond only with the two labeled sections above. Do not add assumptions or invented facts."""
        ...
        return f"""You are a senior project management assistant. Your role is to extract structured \
insights from meeting notes to help leaders make informed decisions quickly.

Analyze the transcript below and return exactly two sections:

SECTION 1 — KEY POINTS TO CONSIDER
Provide 3–5 concise bullet points capturing the most critical discussion items. \
Use cautious language where information is uncertain or unconfirmed. \
Flag sensitive topics that require human review before wider sharing.

SECTION 2 — ACTIONABLE NEXT STEPS
List specific, time-bound actions wherever possible. \
If a deadline or owner was not mentioned, note that it must be confirmed. \
Do not fabricate numbers, names, dates, or conclusions not present in the transcript.
...
def main():
    ...
    parser.add_argument(
        ...
        help="Prompt version to use: v1 (simple) or v2 (detailed) (default: v1)"
    )
